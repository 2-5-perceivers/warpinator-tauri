...
import org.perceivers25.warpinator.core.utils.messages.FailedToWriteLog
import org.perceivers25.warpinator.core.utils.messages.SucceededToWriteLog
import java.io.File
...
object LogFileWriter {
    ...
    fun writeLog(
        ...
        context: Context,
        emitMessage: suspend (UiMessage) -> Unit,
    ) {
        try {
            scope.launch {
